...
class AggregatedInfoApi
{
     ...
     */
    public function balance($currency = null, $account_filter = null)
    {
        list($response) = $this->balanceWithHttpInfo($currency, $account_filter);
        return $response;
    }
     ...
     */
    public function balanceWithHttpInfo($currency = null, $account_filter = null)
    {
        $request = $this->balanceRequest($currency, $account_filter);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function balanceAsync($currency = null, $account_filter = null)
    {
        return $this->balanceAsyncWithHttpInfo($currency, $account_filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function balanceAsyncWithHttpInfo($currency = null, $account_filter = null)
    {
        $returnType = '\blockmate\Model\Balance200Response';
        $request = $this->balanceRequest($currency, $account_filter);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function balanceRequest($currency = null, $account_filter = null)
    {
