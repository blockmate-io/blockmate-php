...
class ExchangeRateInfoApi
{
     ...
     *
     * @param  string $pairs Currency pairs for which exchange rate should be returned (max 20 per request) (required)
     *
     ...
     * @param  string $days Historical dates for which exchange rates should be returned (max 40 per request) (required)
     *
     * @throws \blockmate\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \blockmate\Model\ExchangeRate[]|\blockmate\Model\UserAPIAuthenticateProject400Response|\blockmate\Model\UserAPIAuthenticateProject401Response
