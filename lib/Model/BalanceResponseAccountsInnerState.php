...
/**
 * BalanceResponseAccountsInnerState Class Doc Comment
 *
 * @category Class
 * @package  blockmate
 * @author   OpenAPI Generator team
 ...
 */
class BalanceResponseAccountsInnerState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Balance_response_accounts_inner_state';
    ...
    */
     ...
     * Sets last_sync
     *
     * @param string|null $last_sync null if initial sync was not yet done
     *
     * @return self
     */
