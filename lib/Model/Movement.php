 ...
 */
class Movement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Movement';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name name if known
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category category if known
     *
     * @return self
     */
